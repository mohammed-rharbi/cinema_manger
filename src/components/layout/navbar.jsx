...
// document.body.addEventListener('click', ()=> setHide(true));
...
<div id="dropdown" class={` ${hide ? 'hidden' : 'block'} z-10 p-2 mt-60 ml-16 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700`}>
...
<svg onClick={()=> setHide(true)}  xmlns="http://www.w3.org/2000/svg" height="32px" viewBox="0 -960 960 960" width="48px" fill="#e8eaed"><path d="m249-207-42-42 231-231-231-231 42-42 231 231 231-231 42 42-231 231 231 231-42 42-231-231-231 231Z"/></svg>
    ...
    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
      ...
      <li >
        <Link to={'user_profile'} onClick={()=> setHide(true)}   class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Profile</Link>
      </li>
      <li onClick={()=>Logout()}>
