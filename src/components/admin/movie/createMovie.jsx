                ...
                <form action="" onSubmit={(e) => handleCreate(e)} enctype="multipart/form-data" className="p-4 md:p-5">
                    <div className="grid gap-4 mb-4 grid-cols-2">
                        ...
                        <div className="col-span-2 sm:col-span-1">
                            <label for="price" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">relese Date</label>
                        ...
                        <div className="col-span-2 sm:col-span-1">
                            <label for="category" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Deroctor</label>
                        ...
                        <div className="col-span-2">
                            <label for="description"  className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Movie Description</label>
