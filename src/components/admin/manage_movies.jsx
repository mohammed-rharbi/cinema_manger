...
<div onClick={()=> showCreate()} id='navv' className='flex justify-center justify-items-center bg-blue-700 h-24 w-80 rounded-3xl box-shadow-2xl text-center hover:scale-105 text-white hover:bg-blue-800 hover:box-shadow-2xl'>
