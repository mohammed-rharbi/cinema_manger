...
{ showCreateMovie && <CreateMovie hideIt={hideIt}  />}
...
<div onClick={() => setShowCreateMovie(true)} id='navv' className='flex justify-center justify-items-center bg-blue-700 h-24 w-80 rounded-3xl box-shadow-2xl text-center hover:scale-105 text-white hover:bg-blue-800 hover:box-shadow-2xl'>
...
<div id='navv' className='bg-blue-700 h-24 w-80 rounded-3xl box-shadow-2xl text-center hover:scale-105 text-white hover:bg-blue-800 hover:box-shadow-2xl'>     
    ...
    <div className=' flex justify-content-center flex-wrap gap-8  '>
        ...
        <div key={movie._id} className='p-7 bg-gray-700 text-white rounded-xl w-60 h-120 border border-red-500 box-shadow-2xl hover:scale-105 transition'>

            <div>
                <img src={movie.image}
                className='w-80 h-72 mx-auto hover:scale-110 border-2 border-gray-900 transition'
                alt={movie.title} />
